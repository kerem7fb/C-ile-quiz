...
namespace deneme_quiz
{
    public partial class Form1 : Form
    {
        ...
        {
            yeni.Open();
            OleDbCommand komut = new OleDbCommand("Update AracBilgi Set Marka='" + comboBox1.Text + "',Model='" + textBox1.Text + "',Yakit='" + comboBox4.Text + "',VitesTipi='" + comboBox3.Text + "',Kilometre='" + textBox2.Text + "'Where KapiSayisi='" + textBox3.Text + "'", yeni);
            komut.ExecuteNonQuery();
            yeni.Close();
            görüntüle();
        }
